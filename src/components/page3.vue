...
<script>
const chinaMap  = () => import('./page3/chinaMap.vue');
const channelBar = ()=> import('./page3/channelBar.vue');
const distributionSolider = ()=> import('./page3/distributionSolider.vue');
const pie = ()=> import('./pie.vue');
const redPocket = ()=>import('./page3/redPocket.vue');
const radar = ()=> import('./radar.vue');
const doubleBar = ()=> import('./page3/doubleBar.vue');
const webcastsRisk = ()=> import('./page3/webcastsRisk.vue');
const deviceSafeRisk = ()=> import('./page3/deviceSafeRisk.vue');
const doubleRing = ()=> import('./page3/doubleRing.vue');
const hotWords =() => import('./page3/hotWords.vue');
