...
const radarChart = () => import('./radar.vue');
const barChart = () => import('./page2/barChart.vue');
const doubleBarChart = ()=> import('./page2/doubleBarChart.vue');
const singleAreaChart = () => import('./page2/singleAreaChart.vue');
const doubleLine  = () => import('./page2/doubleLine.vue');
const threeBarChart = () => import('./page2/threeBarChart.vue');
const pieChart = () => import('./page2/pieChart.vue');
const doubleBars = () => import('./page2/doubleBars.vue');
