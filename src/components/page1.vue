...
<script>
const radarPart = () => import('./page1/radarPart.vue');
const doubleArea = () => import('./page1/doubleArea.vue');
const webBar = () => import('./page1/webBar.vue');
const pie = () => import('./pie.vue')
// const worldMap = () => import('./page1/worldMap.vue');
const ring = () => import('./page1/ring.vue');
const popularBar = () => import('./page1/popularBar.vue');
const lines = () => import('./page1/lines.vue');
const pieRing = () => import('./page1/pieRing.vue');
const colorsBar = () => import('./page1/colorsBar.vue');
const funnel = () => import('./page1/funnel.vue');
const lineBar = () => import('./page1/lineBar.vue');
const areaChart = () => import('./areaChart.vue');
